...
export const AuthProvider = ({ children }) => {
  ...
  }, [isAdmin, isAgencyAdmin, user?.id, user?.name]);
  ...
  const getEffectiveUserId = useCallback(() => {
    ...
    return user?.id || null;
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [impersonating.active, impersonating.targetUserId, user?.id]);
  ...
  const getEffectiveUserName = useCallback(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [impersonating.active, impersonating.targetUserName, user?.name]);
  ...
  const getEffectiveOwnerIds = useCallback(() => {
    ...
    return user?.id || null;
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [impersonating.active, impersonating.targetUserId, scopeFilter.active, scopeFilter.ownerIds, user?.id]);
  ...
  }, [scopeFilter.active, impersonating.active]);
